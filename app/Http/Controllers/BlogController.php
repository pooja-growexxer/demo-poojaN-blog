...
class BlogController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       $blogs = $query->latest()->paginate(3)->withQueryString();
        ...
        return view((config('constants.HOME_INDEX')), compact('blogs', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route(config('constants.HOME_INDEX'))
    ...
    public function update(Request $request, Blog $blog)
    {
        ...
        return redirect()->route(config('constants.HOME_INDEX'))->with('status', 'Blog Updated Successfully');
    }
    ...
    public function destroy(Blog $blog)
    {
        ...
        return redirect()->route(config('constants.HOME_INDEX'))->with('status', 'Blog Delete Successfully');
    }
